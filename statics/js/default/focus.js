...
var key=0;
var aF = new Array();
//aF[0] = "progid:DXImageTransform.Microsoft.Barn(function=30, duration=1)"; //中间向两侧
//aF[0] = "progid:DXImageTransform.Microsoft.Blinds(direction='down', duration=1)";  //上下百叶窗
aF[0] = "progid:dximagetransform.microsoft.wipe(gradientsize=1.0,wipestyle=4, motion=forward, duration=2)";  //从左淡入
//aF[3] = "progid:DXImageTransform.Microsoft.CheckerBoard(duration=1, direction='left')";
//aF[0] = "progid:DXImageTransform.Microsoft.Iris(duration=1)"; //十字破开
//aF[0] = "progid:DXImageTransform.Microsoft.Slide(bands=20, duration=1)";
//aF[6] = "progid:DXImageTransform.Microsoft.Spiral(duration=1, GridSizeX=25, GridSizeY=25)"; 
//aF[0] = "progid:DXImageTransform.Microsoft.Strips(duration=1)";  //右上向左
