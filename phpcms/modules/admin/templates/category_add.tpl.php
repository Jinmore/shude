 ...
 <tr>
     <th><?php echo L('add_category_types');?>：</th>
      ...
      <tr>
        ...
        <td>
        <span id="normal_adds"><input type="text" name="info[catname_en]" id="catname_en" class="input-text" value=""></span>
        <span id="batch_adds" style="display:none"> 
        <table width="100%" class="sss"><tr><td width="310"><textarea name="batch_add" maxlength="255" style="width:300px;height:60px;"></textarea></td>
        <td align="left">
        <?php echo L('batch_add_tips');?>
 </td></tr></table>
	...
	<tr id="catdir_tr">
        <th>课程是否开放：</th>
        <td><label><input name="info[quanxian]" type="radio" checked="checked" value="0" />是 </label> <label><input name="info[quanxian]" type="radio" value="1" />否 </label> </td>
      ...
      <tr>
        <th><?php echo "手机版".L('catgory_img')?>：</th>
        <td><?php echo form::images('info[wapimage]', 'wapimage', $wapimage, 'content');?></td>
    </tr>
 <?php    

	$CATS=getcache('category_content_1','commons');

	//echo $CATS[$CATS[$catid][parentid]][parentid];
	if($CATS[$CATS[$catid][parentid]][parentid]==6||$CATS[$catid][parentid]==6){
?>
	 <tr>
        <th><?php echo L('课程icon')?>：</th>
        <td><?php echo form::images('info[icon]', 'icon', $icon, 'content');?></td>
      </tr>
<?php }?>

	<tr>
        <th><?php echo L('description')?>：</th>
        <td><script type="text/javascript" src="/statics/js/ckeditor/ckeditor.js"></script>
<textarea name="info[description]" cols="50" rows="8" id="content"><?php echo $description;?></textarea>
<?php echo form::editor('content','basic','','','',1,1)?></td>
      </tr>
