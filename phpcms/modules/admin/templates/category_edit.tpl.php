...
<table width="100%" class="table_form ">
	  ...
	  <tr>
       ...
       <td><label><input name="info[quanxian]" type="radio"  value="0" <?php if($quanxian==0) echo 'checked';?> />是 </label> <label><input name="info[quanxian]" type="radio"  value="1" <?php if($quanxian==1) echo 'checked';?> />否 </label></td>
...
<?php 
	...
	if($CATS[$CATS[$catid][parentid]][parentid]==6){
?>
 		<tr>
