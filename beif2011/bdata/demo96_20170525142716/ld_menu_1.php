...
E_D("replace into `ld_menu` values('2','module','0','admin','module','init','','2','1','0','1','1','1','1');");
...
E_D("replace into `ld_menu` values('5','members','0','member','member','init','','5','1','1','1','1','1','1');");
...
E_D("replace into `ld_menu` values('74','member_verify','55','member','member_verify','manage','s=0','3','0','1','1','1','1','1');");
...
E_D("replace into `ld_menu` values('1603','exam','4','exam','exam','init','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1604','question','1603','exam','exam','question','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1605','import','1604','exam','exam','importQ','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1606','addSingle','1604','exam','exam','add','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1615','sms_buy_history','1612','sms','sms','sms_buy_history','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1612','sms','29','sms','sms','sms_setting','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1616','sms_api','1612','sms','sms','sms_api','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1613','sms_setting','1612','sms','sms','sms_setting','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1614','sms_pay_history','1612','sms','sms','sms_pay_history','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1617','sms_sent','1612','sms','sms','sms_sent','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1618','mobile','29','mobile','mobile','init','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1619','mobile_add','1618','mobile','mobile','add','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1620','mobile_edit','1618','mobile','mobile','edit','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1621','mobile_delete','1618','mobile','mobile','delete','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1622','cate_manage','1618','mobile','mobile','cate_manage','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1623','formguide','29','formguide','formguide','init','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1624','formguide_add','1623','formguide','formguide','add','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1625','formguide_edit','1623','formguide','formguide','edit','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1626','form_info_list','1623','formguide','formguide_info','init','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1627','formguide_disabled','1623','formguide','formguide','disabled','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1628','formguide_delete','1623','formguide','formguide','delete','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1629','formguide_stat','1623','formguide','formguide','stat','','0','0','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1630','add_public_field','1623','formguide','formguide_field','add','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1631','list_public_field','1623','formguide','formguide_field','init','','0','1','1','1','1','1','1');");
E_D("replace into `ld_menu` values('1632','module_setting','1623','formguide','formguide','setting','','0','0','1','1','1','1','1');");
