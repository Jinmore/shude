...
E_D("replace into `ld_model_field` values('6','1','1','description','摘要','','','0','2048','','','textarea','array (\n  ''width'' => ''98'',\n  ''height'' => ''46'',\n  ''defaultvalue'' => '''',\n  ''enablehtml'' => ''0'',\n)','','','','0','1','0','1','0','1','1','1','6','0','0');");
...
E_D("replace into `ld_model_field` values('59','3','1','relation','相关视频','','','0','0','','','omnipotent','array (\n  ''formtext'' => ''<input type=\\\\''hidden\\\\'' name=\\\\''info[relation]\\\\'' id=\\\\''relation\\\\'' value=\\\\''{FIELD_VALUE}\\\\'' style=\\\\''50\\\\'' >\r\n<ul class=\"list-dot\" id=\"relation_text\"></ul>\r\n<div>\r\n<input type=\\\\''button\\\\'' value=\"添加相关\" onclick=\"omnipotent(\\\\''selectid\\\\'',\\\\''?m=content&c=content&a=public_relationlist&modelid={MODELID}\\\\'',\\\\''添加相关文章\\\\'',1)\" class=\"button\" style=\"width:66px;\">\r\n<span class=\"edit_content\">\r\n<input type=\\\\''button\\\\'' value=\"显示已有\" onclick=\"show_relation({MODELID},{ID})\" class=\"button\" style=\"width:66px;\">\r\n</span>\r\n</div>'',\n  ''fieldtype'' => ''varchar'',\n  ''minnumber'' => ''1'',\n)','','2,6,4,5,1,7','','0','0','0','0','0','0','1','0','55','0','0');");
...
E_D("replace into `ld_model_field` values('63','3','1','description','摘要','','','0','2048','','','textarea','array (\n  ''width'' => ''98'',\n  ''height'' => ''46'',\n  ''defaultvalue'' => '''',\n  ''enablehtml'' => ''0'',\n)','','','','0','1','0','1','0','1','1','1','6','0','0');");
...
E_D("replace into `ld_model_field` values('129','13','1','catid','栏目','','','1','6','/^[0-9]{1,6}\$/','请选择栏目','catid','array (\n  ''defaultvalue'' => '''',\n)','','-99','-99','0','1','0','1','1','1','0','0','1','0','0');");
E_D("replace into `ld_model_field` values('130','13','1','typeid','类别','','','0','0','','','typeid','array (\n  ''minnumber'' => '''',\n  ''defaultvalue'' => '''',\n)','','','','0','1','0','1','1','1','0','0','2','0','0');");
E_D("replace into `ld_model_field` values('131','13','1','title','标题','','inputtitle','1','80','','请输入标题','title','','','','','0','1','0','1','1','1','1','1','4','0','0');");
E_D("replace into `ld_model_field` values('132','13','1','keywords','关键词','多关键词之间用空格或者“,”隔开','','0','40','','','keyword','array (\r\n  ''size'' => ''100'',\r\n  ''defaultvalue'' => '''',\r\n)','','-99','-99','0','1','0','1','1','1','1','0','7','0','0');");
E_D("replace into `ld_model_field` values('133','13','1','description','摘要','','','0','255','','','textarea','array (\r\n  ''width'' => ''98'',\r\n  ''height'' => ''46'',\r\n  ''defaultvalue'' => '''',\r\n  ''enablehtml'' => ''0'',\r\n)','','','','0','1','0','1','0','1','1','1','10','0','0');");
E_D("replace into `ld_model_field` values('134','13','1','updatetime','更新时间','','','0','0','','','datetime','array (\r\n  ''dateformat'' => ''int'',\r\n  ''format'' => ''Y-m-d H:i:s'',\r\n  ''defaulttype'' => ''1'',\r\n  ''defaultvalue'' => '''',\r\n)','','','','1','1','0','1','0','0','0','0','12','0','0');");
E_D("replace into `ld_model_field` values('135','13','1','content','内容','<div class=\"content_attr\"><label><input name=\"add_introduce\" type=\"checkbox\"  value=\"1\" checked>是否截取内容</label><input type=\"text\" name=\"introcude_length\" value=\"200\" size=\"3\">字符至内容摘要\r\n<label><input type=''checkbox'' name=''auto_thumb'' value=\"1\" checked>是否获取内容第</label><input type=\"text\" name=\"auto_thumb_no\" value=\"1\" size=\"2\" class=\"\">张图片作为标题图片\r\n</div>','','1','999999','','内容不能为空','editor','array (\n  ''toolbar'' => ''full'',\n  ''defaultvalue'' => '''',\n  ''enablekeylink'' => ''1'',\n  ''replacenum'' => ''2'',\n  ''link_mode'' => ''0'',\n  ''enablesaveimage'' => ''1'',\n)','','','','0','0','0','1','0','1','1','0','13','0','0');");
E_D("replace into `ld_model_field` values('136','13','1','thumb','缩略图','','','0','100','','','image','array (\n  ''size'' => ''50'',\n  ''defaultvalue'' => '''',\n  ''show_type'' => ''1'',\n  ''upload_maxsize'' => ''1024'',\n  ''upload_allowext'' => ''jpg|jpeg|gif|png|bmp'',\n  ''watermark'' => ''0'',\n  ''isselectimage'' => ''1'',\n  ''images_width'' => '''',\n  ''images_height'' => '''',\n)','','','','0','1','0','0','0','1','0','1','14','0','0');");
E_D("replace into `ld_model_field` values('137','13','1','relation','相关文章','','','0','0','','','omnipotent','array (\n  ''formtext'' => ''<input type=\\\\''hidden\\\\'' name=\\\\''info[relation]\\\\'' id=\\\\''relation\\\\'' value=\\\\''{FIELD_VALUE}\\\\'' style=\\\\''50\\\\'' >\r\n<ul class=\"list-dot\" id=\"relation_text\"></ul>\r\n<div>\r\n<input type=\\\\''button\\\\'' value=\"添加相关\" onclick=\"omnipotent(\\\\''selectid\\\\'',\\\\''?m=content&c=content&a=public_relationlist&modelid={MODELID}\\\\'',\\\\''添加相关文章\\\\'',1)\" class=\"button\" style=\"width:66px;\">\r\n<span class=\"edit_content\">\r\n<input type=\\\\''button\\\\'' value=\"显示已有\" onclick=\"show_relation({MODELID},{ID})\" class=\"button\" style=\"width:66px;\">\r\n</span>\r\n</div>'',\n  ''fieldtype'' => ''varchar'',\n  ''minnumber'' => ''1'',\n)','','2,6,4,5,1,17,18,7','','0','0','0','0','0','0','1','0','15','1','0');");
E_D("replace into `ld_model_field` values('138','13','1','pages','分页方式','','','0','0','','','pages','','','-99','-99','0','0','0','1','0','0','0','0','16','1','0');");
E_D("replace into `ld_model_field` values('139','13','1','inputtime','发布时间','','','0','0','','','datetime','array (\n  ''fieldtype'' => ''int'',\n  ''format'' => ''Y-m-d H:i:s'',\n  ''defaulttype'' => ''0'',\n)','','','','0','1','0','0','0','0','0','1','17','0','0');");
E_D("replace into `ld_model_field` values('140','13','1','posids','推荐位','','','0','0','','','posid','array (\n  ''cols'' => ''4'',\n  ''width'' => ''125'',\n)','','','','0','1','0','1','0','0','0','0','18','1','0');");
E_D("replace into `ld_model_field` values('141','13','1','groupids_view','阅读权限','','','0','100','','','groupid','array (\n  ''groupids'' => '''',\n)','','','','0','0','0','1','0','0','0','0','19','1','0');");
E_D("replace into `ld_model_field` values('142','13','1','url','URL','','','0','100','','','text','','','','','1','1','0','1','0','0','0','0','50','0','0');");
E_D("replace into `ld_model_field` values('143','13','1','listorder','排序','','','0','6','','','number','','','','','1','1','0','1','0','0','0','0','51','0','0');");
E_D("replace into `ld_model_field` values('144','13','1','template','内容页模板','','','0','30','','','template','array (\n  ''size'' => '''',\n  ''defaultvalue'' => '''',\n)','','-99','-99','0','0','0','0','0','0','0','0','53','0','0');");
E_D("replace into `ld_model_field` values('145','13','1','allow_comment','允许评论','','','0','0','','','box','array (\n  ''options'' => ''允许评论|1\r\n不允许评论|0'',\n  ''boxtype'' => ''radio'',\n  ''fieldtype'' => ''tinyint'',\n  ''minnumber'' => ''1'',\n  ''width'' => ''88'',\n  ''size'' => ''1'',\n  ''defaultvalue'' => ''1'',\n  ''outputtype'' => ''0'',\n)','','','','0','0','0','0','0','0','0','0','54','1','0');");
E_D("replace into `ld_model_field` values('146','13','1','status','状态','','','0','2','','','box','','','','','1','1','0','1','0','0','0','0','55','0','0');");
E_D("replace into `ld_model_field` values('147','13','1','readpoint','阅读收费','','','0','5','','','readpoint','array (\n  ''minnumber'' => ''1'',\n  ''maxnumber'' => ''99999'',\n  ''decimaldigits'' => ''0'',\n  ''defaultvalue'' => '''',\n)','','-99','-99','0','0','0','0','0','0','0','0','55','1','0');");
E_D("replace into `ld_model_field` values('148','13','1','username','用户名','','','0','20','','','text','','','','','1','1','0','1','0','0','0','0','98','0','0');");
E_D("replace into `ld_model_field` values('149','13','1','islink','转向链接','','','0','0','','','islink','array (\n  ''size'' => '''',\n)','','','','0','1','0','0','0','1','0','0','20','0','0');");
E_D("replace into `ld_model_field` values('151','3','1','videourl','视频地址','','','0','0','','','text','array (\n  ''size'' => ''50'',\n  ''defaultvalue'' => '''',\n  ''ispassword'' => ''0'',\n)','','','','0','1','0','1','0','1','1','1','7','0','0');");
