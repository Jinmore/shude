...
E_D("replace into `ld_picture_data` values('10','<img src=\"/uploadfile/2017/0519/20170519093044779.jpg\" /><br />\r\n<br />\r\nK1初级课程是一门秉承 &ldquo;玩中学&rdquo;的教育理念集自然，科技，工程，艺术，语言等于一体的综合能力的素质教育课程，它通过传感器，CPU电子器件等，把简单的积木变成好玩的智能机器人。','0','','0','0','','0','','','|0','1');");
E_D("replace into `ld_picture_data` values('11','课程介绍的视频请选择相关','0','','0','0','','0','6|7|15','','|0','1');");
E_D("replace into `ld_picture_data` values('14','国家的啊','0','','0','0','','0','','','|0','1');");
E_D("replace into `ld_picture_data` values('15','','0','','0','0','','0','','','|0','1');");
E_D("replace into `ld_picture_data` values('22','<img src=\"/uploadfile/2017/0519/20170519093248342.jpg\" /><br />\r\n','0','','0','0','','0','','','|0','1');");
